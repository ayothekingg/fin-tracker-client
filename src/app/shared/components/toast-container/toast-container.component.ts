...
import { Toast, ToastService } from '../toast-container/toast.service';
    ...
    <div class="fixed top-4 right-4 z-999 pointer-events-none">
      <div
        *ngFor="let toast of toasts"
        ...
        class="mb-3 px-4 py-3 rounded-lg shadow-lg flex items-center space-x-3 animate-in pointer-events-auto"
      >
        <div>
          <svg
